    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3 group">
          <Image src="/makleologo.png" alt="MAKLEO" width={38} height={38} className="rounded-lg transition-transform duration-300 group-hover:scale-105" priority />
        ...
        <nav className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a key={link.href} href={link.href} className="text-sm font-medium transition-all duration-200"
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="md:hidden p-2" style={{ color: "#a0b4c8" }} onClick={() => setMenuOpen((v) => !v)}>
      ...
      <div className="md:hidden overflow-hidden transition-all duration-300"
        style={{ maxHeight: menuOpen ? "400px" : "0", borderTop: menuOpen ? "1px solid rgba(255,255,255,0.07)" : "none" }}
      >
