...
export const products: Product[] = [
  ...
  },
  {
    ...
    detailedDescription:
      "Goggle de seguridad con recubrimiento antiempañante. Protege contra impactos y salpicaduras químicas. Lente de policarbonato con 99.9% de protección UV y ventilación indirecta para mayor seguridad y comodidad.",
    features: [
      "Recubrimiento antiempañante",
  ...
  },
  {
    id: "10",
    name: "MK-021CL",
    description: "Policarbonato claro, alto impacto, envolvente y cómodo.",
    image: "/MOD.MK-021CL A.jpg",
    imageHover: "/MOD.MK-021CL B.jpg",
    detailedDescription:
      "Lentes de policarbonato claro con protección 99% UV y alta resistencia a impactos. Diseño envolvente, ligero y cómodo. Ideales para uso general industrial.",
    features: [
      "Policarbonato claro",
      "Protección 99% UV",
  ...
  },
  {
    ...
    detailedDescription:
      "Lentes de policarbonato con protección lateral, aptos para ser utilizados sobre gafas de prescripción médica. Claros y ligeros, ideales para visitantes, recorridos y uso temporal en planta.",
    features: [
      "Policarbonato",
      "Protección lateral",
